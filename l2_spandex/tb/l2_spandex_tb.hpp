...
class l2_spandex_tb : public sc_module {
  public:
    ...
    void put_cpu_req(l2_cpu_req_t &cpu_req, cpu_msg_t cpu_msg, hsize_t hsize, addr_t addr,
                     word_t word, hprot_t hprot, amo_t amo, bool aq, bool rl, bool dcs_en,
                     bool use_owner_pred, dcs_t dcs, cache_id_t pred_cid);
    void get_req_out(coh_msg_t coh_msg, addr_t addr, hprot_t hprot, line_t line,
                     word_mask_t word_mask);
    void get_rsp_out(coh_msg_t coh_msg, cache_id_t req_id, bool to_req, addr_t addr, line_t line,
                     word_mask_t word_mask);
    void put_fwd_in(mix_msg_t coh_msg, addr_t addr, cache_id_t req_id, line_t line,
                    word_mask_t word_mask);
    void put_rsp_in(coh_msg_t coh_msg, addr_t addr, line_t line, word_mask_t word_mask,
