...
class l2_spandex : public sc_module {
  ...
  public:
    ...
    EXP_MEM_TYPE_STRING(l2_spandex, states, L2_SETS,
                        L2_WAYS)<sc_uint<SPX_STABLE_STATE_BITS * WORDS_PER_LINE>, L2_LINES> states;
...
#endif
        ,
        flush_done("flush_done"), acc_flush_done("acc_flush_done"), l2_cpu_req("l2_cpu_req"),
        l2_fwd_in("l2_fwd_in"), l2_fwd_out("l2_fwd_out"), l2_rsp_in("l2_rsp_in"),
        l2_flush("l2_flush"), l2_bresp("l2_bresp"), l2_rd_rsp("l2_rd_rsp"), l2_inval("l2_inval"),
        l2_req_out("l2_req_out"), l2_rsp_out("l2_rsp_out")
#ifdef STATS_ENABLE
        ,
        l2_stats("l2_stats")
#endif
    ...
    inline void send_req_out(coh_msg_t coh_msg, hprot_t hprot, line_addr_t line_addr, line_t lines,
                             word_mask_t word_mask);
    inline void send_rsp_out(coh_msg_t coh_msg, cache_id_t req_id, bool to_req,
                             line_addr_t line_addr, line_t line, word_mask_t word_mask);
    inline void send_fwd_out(coh_msg_t coh_msg, cache_id_t dst_id, bool to_dst,
                             line_addr_t line_addr, line_t line, word_mask_t word_mask);
    ...
    void fill_reqs(cpu_msg_t cpu_msg, addr_breakdown_t addr_br, l2_tag_t tag_estall,
                   ...
                   word_t word, line_t line, word_mask_t word_mask, sc_uint<REQS_BITS> reqs_i);
    ...
    void add_wb(bool &success, addr_breakdown_t addr_br, word_t word, l2_way_t way, hprot_t hprot,
                bool dcs_en, bool use_owner_pred, cache_id_t pred_cid);
