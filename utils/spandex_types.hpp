...
class l2_cpu_req_t {
  ...
  public:
    ...
    l2_cpu_req_t() :
        cpu_msg(0), hsize(0), hprot(0), addr(0), word(0), amo(0), aq(0), rl(0), dcs_en(0),
        use_owner_pred(0), dcs(0), pred_cid(0)
    {
    }
    ...
    inline bool operator==(const l2_cpu_req_t &x) const
    {
        return (x.cpu_msg == cpu_msg && x.hsize == hsize && x.hprot == hprot && x.addr == addr &&
                x.word == word && x.amo == amo && x.aq == aq && x.rl == rl && x.dcs_en == dcs_en &&
                x.use_owner_pred == use_owner_pred && x.dcs == dcs && x.pred_cid == pred_cid);
    }
    ...
    inline friend ostream &operator<<(ostream &os, const l2_cpu_req_t &x)
    {
        os << hex << "("
           ...
           << ", addr: " << x.addr << ", word: " << x.word << ", amo: " << x.amo << ", aq: " << x.aq
           << ", rl: " << x.rl << ", dcs_en: " << x.dcs_en
           << ", use_owner_pred: " << x.use_owner_pred << ", dcs: " << x.dcs
           << ", pred_cid: " << x.pred_cid << ")";
        return os;
    }
};
...
class l2_inval_t {
  public:
    ...
    {
        return ((x.addr == addr) && (x.hprot == hprot));
    }
...
class l2_fwd_in_t {
  ...
  public:
    ...
    l2_fwd_in_t() : coh_msg(0), addr(0), req_id(0), line(0), word_mask(0) {}
    ...
    {
        return (x.coh_msg == coh_msg && x.addr == addr && x.req_id == req_id && x.line == line &&
    ...
    inline friend ostream &operator<<(ostream &os, const l2_fwd_in_t &x)
    {
        os << hex << "("
           ...
           << ", line: " << x.line << ", word_mask:" << x.word_mask << ")";
        return os;
    }
};
...
class l2_rsp_in_t {
  ...
  public:
    ...
    l2_rsp_in_t() : coh_msg(0), addr(0), line(0), word_mask(0), invack_cnt(0) {}
    ...
    inline bool operator==(const l2_rsp_in_t &x) const
    {
        return (x.coh_msg == coh_msg && x.addr == addr && x.line == line &&
                x.word_mask == word_mask && x.invack_cnt == invack_cnt);
    }
  ...
  public:
    ...
    inline bool operator==(const llc_rsp_out_t &x) const
    {
        return (x.coh_msg == coh_msg && x.addr == addr && x.line == line &&
                ...
                x.word_offset == word_offset && x.word_mask == word_mask);
    }
    ...
    inline friend ostream &operator<<(ostream &os, const llc_rsp_out_t &x)
    {
        ...
        os << ", invack_cnt: " << x.invack_cnt << ", req_id: " << x.req_id
           << ", dest_id: " << x.dest_id << ", word_mask: " << x.word_mask
           << ", word_offset: " << x.word_offset << ")";
        return os;
    }
};
...
class llc_fwd_out_t {
  ...
  public:
    ...
    llc_fwd_out_t() : coh_msg(0), addr(0), req_id(0), dest_id(0), line(0), word_mask(0) {}
    ...
    inline bool operator==(const llc_fwd_out_t &x) const
    {
        return (x.coh_msg == coh_msg && x.addr == addr && x.req_id == req_id &&
                x.dest_id == dest_id && x.line == line && x.word_mask == word_mask);
    }
    ...
    inline friend ostream &operator<<(ostream &os, const llc_fwd_out_t &x)
    {
        ...
        os << ", addr: " << x.addr << ", req_id: " << x.req_id << ", line: " << x.line
           << ", word_mask: " << x.word_mask << ", dest_id: " << x.dest_id << ")";
        return os;
    }
};
...
class l2_req_out_t {
  ...
  public:
    ...
    l2_req_out_t() : coh_msg(coh_msg_t(0)), hprot(0), addr(0), line(0), word_mask(0) {}
...
template <unsigned REQ_ID_WIDTH> class llc_req_in_t {
  ...
  public:
    ...
    llc_req_in_t() :
        coh_msg(coh_msg_t(0)), hprot(0), addr(0), line(0), req_id(0), word_offset(0),
        valid_words(0), word_mask(0)
    {
    }
    ...
    {
        return (x.coh_msg == coh_msg && x.hprot == hprot && x.addr == addr && x.line == line &&
                x.req_id == req_id && x.word_offset == word_offset &&
                x.valid_words == valid_words && x.word_mask == word_mask);
    }
...
class l2_rsp_out_t {
  ...
  public:
    ...
    l2_rsp_out_t() : coh_msg(coh_msg_t(0)), req_id(0), to_req(0), addr(0), line(0), word_mask(0) {}
    ...
    inline bool operator==(const l2_rsp_out_t &x) const
    {
        return (x.coh_msg == coh_msg && x.req_id == req_id && x.to_req == to_req &&
                x.addr == addr && x.line == line && x.word_mask == word_mask);
    }
...
class l2_fwd_out_t {
  ...
  public:
    ...
    l2_fwd_out_t() : coh_msg(coh_msg_t(0)), req_id(0), to_req(0), addr(0), line(0), word_mask(0) {}
...
class llc_rsp_in_t {
  ...
  public:
    ...
    llc_rsp_in_t() : coh_msg(0), addr(0), line(0), req_id(0), word_mask(0) {}
...
class wb_t {
  public:
    ...
    wb_t() :
        valid(0), tag(0), set(0), way(0), hprot(0), line(0), word_mask(0), dcs_en(0),
        use_owner_pred(0), pred_cid(0)
    {
    }
    ...
    inline bool operator==(const wb_t &x) const { return false; }
    inline friend void sc_trace(sc_trace_file *tf, const wb_t &x, const std::string &name) {}
    inline friend ostream &operator<<(ostream &os, const wb_t &x) { return os; }
};
...
class reqs_buf_t {
  ...
  public:
    ...
    reqs_buf_t() :
        ...
        hprot(0), invack_cnt(0), word(0), line(0), word_mask(0), type(0)
    {
    }
    ...
    inline bool operator==(const reqs_buf_t &x) const
    {
        return (x.cpu_msg == cpu_msg && x.tag == tag && x.tag_estall == tag_estall &&
                ...
                x.invack_cnt == invack_cnt && x.word == word && x.word_mask == word_mask &&
                x.line == line && x.type == type);
    }
...
class llc_reqs_buf_t {
  ...
  public:
    ...
    llc_reqs_buf_t() :
        msg(0), tag(0), tag_estall(0), set(0), way(0), w_off(0), b_off(0), state(0), hprot(0),
        invack_cnt(0), word(0), line(0), word_mask(0), is_amo(0)
    {
    }
    ...
    {
        return (x.msg == msg && x.tag == tag && x.tag_estall == tag_estall && x.set == set &&
                x.way == way && x.w_off == w_off && x.b_off == b_off && x.state == state &&
                x.hprot == hprot && x.invack_cnt == invack_cnt && x.word == word &&
                x.line == line && x.word_mask == word_mask);
    }
    ...
    {
        os << hex << "("
           << "msg: " << x.msg << "tag: " << x.tag << "tag_estall: " << x.tag_estall
           << ", set: " << x.set << ", way: " << x.way << ", w_off: " << x.w_off
           << ", b_off: " << x.b_off << ", state: " << x.state << ", hprot: " << x.hprot
           << ", invack_cnt: " << x.invack_cnt << ", word: " << x.word << ", line: ";
        for (int i = WORDS_PER_LINE - 1; i >= 0; --i) {
            int base = i * BITS_PER_WORD;
            os << x.line.range(base + BITS_PER_WORD - 1, base) << " ";
        }
