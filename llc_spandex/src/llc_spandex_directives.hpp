...
#define LLC_MAP_MEMORY                                                                         \
    ...
    HLS_MAP_TO_MEMORY(dirty_bits,                                                              \
                      IMP_MEM_NAME_STRING(llc_spandex, dirty_bits, LLC_SETS, LLC_WAYS));       \
    HLS_MAP_TO_MEMORY(evict_ways,                                                              \
                      IMP_MEM_NAME_STRING(llc_spandex, evict_ways, LLC_SETS, LLC_WAYS));       \
    ...
    #define LLC_REQS bookmark_tmp |= BM_LLC_REQS
    ...
    #define REQS_IV bookmark_tmp |= BM_GETS_IV
    ...
    #define LLC_REQS_LOOKUP_LOOP HLS_UNROLL_LOOP(ON, "llc-reqs-lookup-loop-unroll")
    ...
    #define LLC_REQS_PEEK_REQ_LOOP HLS_UNROLL_LOOP(ON, "llc-reqs-peek-req-loop-unroll")
    ...
    #define LLC_REQS_PEEK_FWD_LOOP HLS_UNROLL_LOOP(ON, "llc-reqs-peek-fwd-loop-unroll")
