...
void llc_spandex_tb::llc_test()
{
    ...
    get_mem_req(0 /* hwrite */, WORD /* hsize */, DATA /* hprot */, addr.word /* addr */,
                0 /* line */);
    ...
    get_fwd_out(FWD_REQ_O /* coh_msg */, addr.word /* addr */, 1 /* req_id */, 0 /* dest_id */,
                0b01 /* word_mask*/);
    ...
    get_fwd_out(FWD_REQ_S /* coh_msg */, addr.word /* addr */, 2 /* req_id */, 1 /* dest_id */,
                0b11 /* word_mask*/);

    put_rsp_in(RSP_RVK_O /* rsp_msg */, addr.word /* addr */, line /* line */, 1 /* req_id */,
               0b11 /* word_mask */);
    ...
    get_fwd_out(FWD_INV_SPDX /* coh_msg */, addr.word /* addr */, 0 /* req_id */, 1 /* dest_id */,
                0b10 /* word_mask*/);

    wait();

    get_fwd_out(FWD_INV_SPDX /* coh_msg */, addr.word /* addr */, 0 /* req_id */, 2 /* dest_id */,
                0b10 /* word_mask*/);

    wait();

    get_fwd_out(FWD_INV_SPDX /* coh_msg */, addr.word /* addr */, 0 /* req_id */, 3 /* dest_id */,
                0b10 /* word_mask*/);

    put_rsp_in(RSP_INV_ACK_SPDX /* rsp_msg */, addr.word /* addr */, orig_line /* line */,
               1 /* req_id */, 0b11 /* word_mask */);

    wait();

    put_rsp_in(RSP_INV_ACK_SPDX /* rsp_msg */, addr.word /* addr */, orig_line /* line */,
               2 /* req_id */, 0b11 /* word_mask */);

    wait();

    put_rsp_in(RSP_INV_ACK_SPDX /* rsp_msg */, addr.word /* addr */, orig_line /* line */,
               3 /* req_id */, 0b11 /* word_mask */);
    ...
    get_fwd_out(FWD_REQ_S /* coh_msg */, addr.word /* addr */, 1 /* req_id */, 0 /* dest_id */,
                0b10 /* word_mask*/);

    put_rsp_in(RSP_S /* rsp_msg */, addr.word /* addr */, line /* line */, 0 /* req_id */,
               0b10 /* word_mask */);
    ...
    get_fwd_out(FWD_REQ_Odata /* coh_msg */, addr.word /* addr */, 1 /* req_id */, 0 /* dest_id */,
                0b10 /* word_mask*/);
    ...
    get_fwd_out(FWD_REQ_S /* coh_msg */, addr.word /* addr */, 0 /* req_id */, 1 /* dest_id */,
                0b10 /* word_mask*/);
    ...
    put_rsp_in(RSP_INV_ACK_SPDX /* rsp_msg */, addr.word /* addr */, line /* line */,
               1 /* req_id */, 0b11 /* word_mask */);
...
void llc_spandex_tb::get_rsp_out(coh_msg_t coh_msg, addr_t addr, line_t line,
                                 invack_cnt_t invack_cnt, cache_id_t req_id, cache_id_t dest_id,
                                 word_offset_t woff, word_mask_t word_mask)
{
    ...
    if (rsp_out.coh_msg != coh_msg || rsp_out.addr != addr.range(TAG_RANGE_HI, SET_RANGE_LO) ||
        (rsp_out.coh_msg != RSP_O && rsp_out.line != line) || rsp_out.invack_cnt != invack_cnt ||
        rsp_out.req_id != req_id || rsp_out.dest_id != dest_id || rsp_out.word_offset != woff ||
...
void llc_spandex_tb::get_dma_rsp_out(coh_msg_t coh_msg, addr_t addr, line_t line,
                                     invack_cnt_t invack_cnt, llc_coh_dev_id_t req_id,
                                     cache_id_t dest_id, word_offset_t woff)
{
...
void llc_spandex_tb::get_fwd_out(mix_msg_t coh_msg, addr_t addr, cache_id_t req_id,
                                 cache_id_t dest_id, word_mask_t word_mask)
{
    ...
    if (fwd_out.coh_msg != coh_msg || fwd_out.addr != addr.range(TAG_RANGE_HI, SET_RANGE_LO) ||
        fwd_out.req_id != req_id || fwd_out.dest_id != dest_id || fwd_out.word_mask != word_mask) {
...
void llc_spandex_tb::get_mem_req(bool hwrite, hsize_t hsize, hprot_t hprot, addr_t addr,
                                 line_t line)
{
    ...
    if (mem_req.hwrite != hwrite || mem_req.hsize != hsize || mem_req.hprot != hprot ||
        mem_req.addr != addr.range(TAG_RANGE_HI, SET_RANGE_LO) || mem_req.line != line) {
...
void llc_spandex_tb::put_dma_req_in(mix_msg_t coh_msg, addr_t addr, line_t line,
                                    llc_coh_dev_id_t req_id, hprot_t hprot, word_offset_t woff,
...
void llc_spandex_tb::put_rsp_in(coh_msg_t rsp_msg, addr_t addr, line_t line, cache_id_t req_id,
                                word_mask_t word_mask)
{
    llc_rsp_in_t rsp_in;
